...
// .wrangler/tmp/bundle-fZM6Po/strip-cf-connecting-ip-header.js
  ...
  "../../node_modules/pg-types/lib/binaryParsers.js"(exports, module) {
    ...
    var parseFloatFromBits = /* @__PURE__ */ __name(function(data, precisionBits, exponentBits) {
      ...
      if (exponent == Math.pow(2, exponentBits + 1) - 1) {
        if (mantissa === 0) {
          return sign4 === 0 ? Infinity : -Infinity;
        }
        return NaN;
      }
      return (sign4 === 0 ? 1 : -1) * Math.pow(2, exponent - bias) * mantissa;
    }, "parseFloatFromBits");
    ...
    var parseNumeric = /* @__PURE__ */ __name(function(value) {
      var sign4 = parseBits(value, 16, 32);
      if (sign4 == 49152) {
        return NaN;
      }
      ...
      return (sign4 === 0 ? 1 : -1) * Math.round(result * scale) / scale;
    }, "parseNumeric");
    var parseDate = /* @__PURE__ */ __name(function(isUTC, value) {
      var sign4 = parseBits(value, 1);
      var rawValue = parseBits(value, 63, 1);
      var result = new Date((sign4 === 0 ? 1 : -1) * rawValue / 1e3 + 9466848e5);
      if (!isUTC) {
...
`;
    ...
    __name(dump, "dump");
    function log5(...args) {
      debug5 && console.log(...args.map(dump));
    }
    __name(log5, "log");
  }
});
  ...
  "../../node_modules/@prisma/client/runtime/wasm.js"(exports, module) {
    ...
    var dn = se(() => {
      ...
      R.squareRoot = R.sqrt = function() {
        ...
        for (e = $(a), U = false, i = Math.sqrt(+a), i == 0 || i == 1 / 0 ? (t = ae(a.d), (t.length + e) % 2 == 0 && (t += "0"), i = Math.sqrt(t), e = Ue((e + 1) / 2) - (e < 0 || e % 2), i == 1 / 0 ? t = "5e" + e : (t = i.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + e), n = new u(t)) : n = new u(i.toString()), r = u.precision, i = s = r + 3; ; )
      ...
      ye = function() {
        ...
        return function(n, i, o, s) {
          ...
          for (u = n.e - i.e, ie = q.length, Ae = oe.length, A = new Ot(No), M = A.d = [], g = 0; q[g] == (oe[g] || 0); )
            ++g;
          if (q[g] > (oe[g] || 0) && --u, o == null ? z = o = Ot.precision : s ? z = o + ($(n) - $(i)) + 1 : z = o, z < 0)
            return new Ot(0);
...
// .wrangler/tmp/bundle-fZM6Po/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-fZM6Po/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var debug4 = (0, import_debug.Debug)("prisma:driver-adapter:pg");
var PgQueryable = /* @__PURE__ */ __name(class {
  ...
  async performIO(query) {
    ...
    try {
      ...
      const error3 = e;
      debug4("Error in performIO: %O", error3);
...
var PgTransactionContext = /* @__PURE__ */ __name(class extends PgQueryable {
  constructor(conn) {
    super(conn);
    this.conn = conn;
  }
...
var PrismaPg = /* @__PURE__ */ __name(class extends PgQueryable {
  constructor(client, options) {
...
var verify2 = /* @__PURE__ */ __name(async (token, secret, alg = "HS256") => {
...
// ../../node_modules/hono/dist/middleware/jwt/index.js
var verify3 = jwt_exports.verify;
...
async function verifyPassword(password, hash2) {
  try {
    const [saltHex, storedHash] = hash2.split(":");
...
async function authMiddleware(c, next) {
  ...
  try {
    const payload = await verify3(token, jwtSecret);
    c.set("user", payload);
    await next();
  } catch (error3) {
...
dashboard.get("/", authMiddleware, async (c) => {
  try {
    ...
    if (user.role === "EMPLOYEE") {
      ...
      const currentMonthEnd = /* @__PURE__ */ new Date();
...
function getAllowedOrigin(origin, env2) {
  ...
  if (env2?.APP_BASE_URL)
    allowed.add(env2.APP_BASE_URL);
  if (origin) {
    if (allowed.has(origin))
      return origin;
    if (origin.endsWith(".collectra.pages.dev"))
      return origin;
  }
  if (!origin)
...
var src_default = {
  async fetch(request, env2, ctx) {
    try {
      return await app.fetch(request, { ...env2, __executionCtx: ctx }, ctx);
    } catch (err2) {
