...
// .wrangler/tmp/bundle-bN3b2h/checked-fetch.js
...
// .wrangler/tmp/bundle-bN3b2h/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-bN3b2h/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-bN3b2h/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
app.get("/", (c) => {
  return c.json({ message: "Dish Hobby Cable Visons API", status: "ok" });
});
